...
class SeasonsModel(models.Model):
    ...
    host_id = models.ForeignKey(HostsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    encoder_FUI = models.CharField(null=False, blank=True, max_length=1023)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at =models.DateTimeField(auto_now=True)
...
class EpisodesModel(models.Model):
    ...
    host_id = models.ForeignKey(HostsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    season_id = models.ForeignKey(SeasonsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    category_id = models.ForeignKey(CategoriesModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    encoder_FUI = models.CharField(null=False, blank=True, max_length=1023)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at =models.DateTimeField(auto_now=True)
