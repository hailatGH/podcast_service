...
class HostsModel(models.Model):
    ...
    host_profileImage = models.ImageField(null=False, blank=True, upload_to=Hosts_Cover_Images, validators=[validators.validate_image_extension])
...
class PodcastsModel(models.Model):
    ...
    podcast_coverImage = models.ImageField(null=False, blank=True, upload_to=Podcasts_Cover_Images, validators=[validators.validate_image_extension])
    host = models.ForeignKey(HostsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    category= models.ForeignKey(CategoriesModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    encoder_FUI = models.CharField(null=False, blank=True, max_length=1023)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at =models.DateTimeField(auto_now=True)
...
class SeasonsModel(models.Model):
    ...
    podcast = models.ForeignKey(PodcastsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    encoder_FUI = models.CharField(null=False, blank=True, max_length=1023)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at =models.DateTimeField(auto_now=True)
...
class EpisodesModel(models.Model):
    ...
    category = models.ForeignKey(CategoriesModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    podcast = models.ForeignKey(PodcastsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    season = models.ForeignKey(SeasonsModel, null=False, blank=True, default=1, on_delete=models.DO_NOTHING)
    encoder_FUI = models.CharField(null=False, blank=True, max_length=1023)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at =models.DateTimeField(auto_now=True)
